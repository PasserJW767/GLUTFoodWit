...
public class CanteenThirdActivity extends AppCompatActivity implements View.OnClickListener{
    int canten_id=3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canteen_third);
        userTel=getIntent().getExtras().getString("userTel");

        initContent();//初始化店铺布局
        showShops();

        layout=findViewById(R.id.ll_third);
    ...
    private void initContent(){
        //整个页面线性布局
        ll_all=new LinearLayout(CanteenThirdActivity.this);
        ...
        //整个页面的滚动视图
        sv_all=new ScrollView(CanteenThirdActivity.this);
...
//                创建每个店铺布局
        ll_item = new LinearLayout(CanteenThirdActivity.this);
            ...
            switch (msg.what){
                ...
                case 0:
                    ...
                    for(int i = 0;i < arrLength;i++){
                        allChildLinearLayout[i] = new LinearLayout(CanteenThirdActivity.this);
                        ...
                        allChildLinearLayout[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                               ...
                               /* Log.i("店铺",(String) tv1.getText());
                                ...
                                Intent intent = new Intent(CanteenThirdActivity.this, ShopDetailActivity.class);
...
//                    初始化所有的店铺图标
                    ...
                    ImageView iv_shopIcon = new ImageView(CanteenThirdActivity.this);
                    //  设置图标
                ...
                case 2:
                    ...
                    TextView tv_shopname = new TextView(CanteenThirdActivity.this);
                ...
                case 3:
                    ...
                    ImageView iv_star = new ImageView(CanteenThirdActivity.this);
                ...
                case 4:
                    ...
                    TextView tv_starsize = new TextView(CanteenThirdActivity.this);
                ...
                case 5:
                    ...
                    TextView tv_monthlysales=new TextView(CanteenThirdActivity.this);
                ...
                case 6:
                    ...
                    TextView tv_averageprice=new TextView(CanteenThirdActivity.this);
                    ...
                    break;
                case 7:
                    TextView tv_id=new TextView(CanteenThirdActivity.this);
