...
public class OtherOrderActivity extends AppCompatActivity {
...
//        设置透明状态栏
        setStatusBar();
        setContentView(R.layout.activity_otherorder);
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    Log.e("orderInfoListLength", String.valueOf(orderInfoList.size()));
                ...
                case 2:
                    ...
                    adapter = new SimpleAdapter(OtherOrderActivity.this,listItems,R.layout.order_item,
    ...
    private void getData(){
        new Thread(() -> {
            ...
            if("待付款".equals(title)){
                allOrderCount = new OrderInfoDao().getAllOrderCountWithKey(userTel,1);
                orderInfoList = new OrderInfoDao().getAllOrderWithKey(userTel, 1);
            } else if("待使用".equals(title)){
                allOrderCount = new OrderInfoDao().getAllOrderCountWithKey(userTel,2);
                orderInfoList = new OrderInfoDao().getAllOrderWithKey(userTel, 2);
            } else if("待退款".equals(title)){
                allOrderCount = new OrderInfoDao().getAllOrderCountWithKey(userTel,3);
                orderInfoList = new OrderInfoDao().getAllOrderWithKey(userTel, 3);
            } else if("待评分".equals(title)){
                allOrderCount = new OrderInfoDao().getAllOrderCountWithKey(userTel,4);
                orderInfoList = new OrderInfoDao().getAllOrderWithKey(userTel, 4);
            }
...
//        userTel = "14795572282";
    ...
    private void addListener(){
        findViewById(R.id.btn_back).setOnClickListener(new View.OnClickListener() {
            ...
            Intent intent = new Intent(OtherOrderActivity.this, My.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(OtherOrderActivity.this, OrderDetailActivity.class);
    ...
    private void checkPermission(Activity activity) {//开启本地的照片读取与写入权限
        ...
        try {
            //检测是否有写的权限
            int permission = ActivityCompat.checkSelfPermission(OtherOrderActivity.this,
                    "android.permission.WRITE_EXTERNAL_STORAGE");
            if (permission != PackageManager.PERMISSION_GRANTED) {
                // 没有写的权限，去申请写的权限，会弹出对话框
                ActivityCompat.requestPermissions(OtherOrderActivity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
            }
            if(ContextCompat.checkSelfPermission(OtherOrderActivity.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(OtherOrderActivity.this,new String[]{Manifest.permission.CALL_PHONE},1);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
