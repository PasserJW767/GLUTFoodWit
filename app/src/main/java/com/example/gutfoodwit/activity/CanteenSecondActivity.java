...
public class CanteenSecondActivity extends AppCompatActivity implements View.OnClickListener{
    int canten_id=2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout=findViewById(R.id.ll_second);
    ...
    private void initContent(){
        //整个页面线性布局
        ll_all=new LinearLayout(CanteenSecondActivity.this);
        ...
        //整个页面的滚动视图
        sv_all=new ScrollView(CanteenSecondActivity.this);
...
//                创建每个店铺布局
        ll_item = new LinearLayout(CanteenSecondActivity.this);
            ...
            switch (msg.what){
                ...
                case 0:
                    ...
                    for(int i = 0;i < arrLength;i++){
                        allChildLinearLayout[i] = new LinearLayout(CanteenSecondActivity.this);
                        ...
                        allChildLinearLayout[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                               ...
                               /* Log.i("店铺",(String) tv1.getText());
                                ...
                                Intent intent = new Intent(CanteenSecondActivity.this, ShopDetailActivity.class);
...
//                    初始化所有的店铺图标
                    ...
                    ImageView iv_shopIcon = new ImageView(CanteenSecondActivity.this);
                    //  设置图标
                ...
                case 2:
                    ...
                    TextView tv_shopname = new TextView(CanteenSecondActivity.this);
                ...
                case 3:
                    ...
                    ImageView iv_star = new ImageView(CanteenSecondActivity.this);
                ...
                case 4:
                    ...
                    TextView tv_starsize = new TextView(CanteenSecondActivity.this);
                ...
                case 5:
                    ...
                    TextView tv_monthlysales=new TextView(CanteenSecondActivity.this);
                ...
                case 6:
                    ...
                    TextView tv_averageprice=new TextView(CanteenSecondActivity.this);
                    ...
                    break;
                case 7:
                    TextView tv_id=new TextView(CanteenSecondActivity.this);
